...
import { DEFAULT_TOLERANCES } from '@/viz2d/render/types';
import { sampleSegment, tangentFrame } from '@/viz2d/render/sample';
import { strokeOutline } from '@/viz2d/render/stroke';
import { markAxes } from '@/viz2d/render/marks';
import { SpherePerspective, trigRoots } from '@/viz2d/sphere/projection';
import { buildSpherePathList, type SphereBuildContext } from '@/viz2d/sphere/scene';
